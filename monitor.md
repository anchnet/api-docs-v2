...
| counter | String | Yes | 监控项 [<br>{<br>&nbsp;&nbsp;"cpu.busy": "CPU使用率",<br>&nbsp;&nbsp;"load.load1": "Linux系统 1分钟负载",<br>&nbsp;&nbsp;"load.load5": "Linux系统 5分钟负载",<br>&nbsp;&nbsp;"load.load15": "Linux系统 15分钟负载",<br>&nbsp;&nbsp;"load.load1": "windows系统 1分钟负载",<br>&nbsp;&nbsp;"load.load5": "windows系统 5分钟负载",<br>&nbsp;&nbsp;"load.load15": "windows系统 15分钟负载",<br>&nbsp;&nbsp;"mem.memused.percent": "内存使用率",<br>&nbsp;&nbsp;"net.if.in.bytes": "进方向流量",<br>&nbsp;&nbsp;"net.if.out.bytes": "出方向流量",<br>&nbsp;&nbsp;"disk.io.write_bytes": "IO写速率",<br>&nbsp;&nbsp;"disk.io.read_bytes": "IO读速率",<br>&nbsp;&nbsp;"tcp.closed": "windows的 tcp.closed",<br>&nbsp;&nbsp;"tcp.timewait": "windows的 tcp.timewait",<br>&nbsp;&nbsp;"tcp.synrecv": "windows的 tcp.synrecv",<br>&nbsp;&nbsp;"tcp.slabinfo.timewait": "windows的 tcp.slabinfo.timewait",<br>&nbsp;&nbsp;"tcp.orphaned": "windows的 tcp.orphaned",<br>&nbsp;&nbsp;"tcp.estab": "windows的 tcp.estab",<br>&nbsp;&nbsp;"ss.closed": "linux的 tcp.closed",<br>&nbsp;&nbsp;"ss.timewait": "linux的 tcp.timewait",<br>&nbsp;&nbsp;"ss.synrecv": "linux的 tcp.synrecv",<br>&nbsp;&nbsp;"ss.slabinfo.timewait": "linux的 tcp.slabinfo.timewait",<br>&nbsp;&nbsp;"ss.orphaned": "linux的 tcp.orphaned",<br>&nbsp;&nbsp;"ss.estab": "linux的 tcp.estab",<br> }<br>]|
